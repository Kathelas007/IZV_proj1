...
class DataDownloader():
    ...
    date_rows = [3]
    string_rows = [51, 52, 53, 54, 55, 56, 57, 58, 59, 62]
    ...
    column_names = ['p2a', 'h', 'i', 'j', 'k', 'l', 'n', 'o', 'p', 'q', 't', 'p1', 'p36', 'p37', 'weekday(p2a)', 'p2b',
                    'p6', 'p7', 'p8', 'p9', 'p10', 'p11', 'p12', 'p13a', 'p13b', 'p13c', 'p14', 'p15', 'p16', 'p17',
                    'p18', 'p19', 'p20', 'p21', 'p22', 'p23', 'p24', 'p27', 'p28', 'p34', 'p35', 'p39', 'p44', 'p45a',
                    'p47', 'p48a', 'p49', 'p50a', 'p50b', 'p51', 'p52', 'p53', 'p55a', 'p57', 'p58', 'r', 's', 'p5a',
                    'a', 'b', 'd', 'e', 'f', 'g', 'reg']

    column_description = ['rok mesic den', 'h', 'i', 'j', 'k', 'l', 'n', 'o', 'p', 'q', 't', 'id',
                          'druh pozemni komunikace', 'cislo pozemni komunikace', 'den v tydnu', 'cas', 'druh nehody',
                          ...
                          'vnejso ovlivneni', 'r', 's', 'lokalita nehody', 'a', 'b', 'd', 'e', 'f', 'g', 'reg']
    ...
    def clean_numpy_data(self, data_list, region):
        ...
        # correct ONE row in whole data, that was corrupted
        if region == "PLK":
            spoiled_colls = range(45, 56)
            index = np.where(data[spoiled_colls[0]] == "A:")
            data[spoiled_colls, (*index[0])] = ""
        ...
        data_ints = np.where(np.logical_or(data[self.int_rows] == "", data[self.int_rows] == '2423A1012423A100'), -1,
                             data[self.int_rows])
    ...
    def get_list(self, regs=None):
        ...
        return tuple([self.column_names, list([item for sublist in return_list for item in sublist])])
